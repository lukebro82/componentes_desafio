  ...
  componentEl.innerHTML = ` 
    ...
    <template id="contenido-container">
        <div class="contenido-container">
          ...
          <a href="" class="container-link">Ver mas..</a>
           </div>
      </template>
...
function obtenerData(resultado) {
  ...
  for (i = 0; i < resultado.items.length; i++) {
    ...
    clone.querySelector(".container-link").href = resultado.items[i].fields.url;
...
function Contentful() {
  fetch(
    "https://cdn.contentful.com/spaces/xvc1gx2u86ps/environments/master/entries?access_token=vhRKm_LE9OHrMPOFHbImd3mMFRKI3Gvuc7JToATa5PU&content_type=porfolio"
  )
